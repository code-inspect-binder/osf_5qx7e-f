...
cogito$wm_trans_t1<-(cogito$animals_acc+cogito$nb_num_acc+cogito$mus_pre_acc)/3
...
cogito$wm_trans_t2<-(cogito$animals_acc_post+cogito$nb_num_acc_post+cogito$mus_post_acc)/3

# Estimation of Bayes Factors (Supplemental Table S3)

# Practiced WM tasks
v<-subset(cogito,select=c("obs","wm_t1","wm_t2","v_t1","v_t2"))
v1<-subset(cogito,select=c("obs","wm_t1","wm_t2","v1_t1","v1_t2"))
v2<-subset(cogito,select=c("obs","wm_t1","wm_t2","v2_t1","v2_t2"))
v3<-subset(cogito,select=c("obs","wm_t1","wm_t2","v3_t1","v3_t2"))
v4<-subset(cogito,select=c("obs","wm_t1","wm_t2","v4_t1","v4_t2"))

cor(v1[,2:5])
set.seed(123)
cor_v1 <- cor_test(v1[,2:5],iter=50000)
BF_v1 <- BF(cor_v1, hypothesis = "wm_t1_with_v1_t1 > wm_t2_with_v1_t2;wm_t1_with_v1_t1 < wm_t2_with_v1_t2;wm_t1_with_v1_t1 = wm_t2_with_v1_t2")
summary(BF_v1)

cor(v2[,2:5])
set.seed(123)
cor_v2 <- cor_test(v2[,2:5],iter=50000)
BF_v2 <- BF(cor_v2, hypothesis = "wm_t1_with_v2_t1 > wm_t2_with_v2_t2;wm_t1_with_v2_t1 < wm_t2_with_v2_t2;wm_t1_with_v2_t1 = wm_t2_with_v2_t2")
summary(BF_v2)

cor(v3[,2:5])
set.seed(123)
cor_v3 <- cor_test(v3[,2:5],iter=50000)
BF_v3 <- BF(cor_v3, hypothesis = "wm_t1_with_v3_t1 > wm_t2_with_v3_t2;wm_t1_with_v3_t1 < wm_t2_with_v3_t2;wm_t1_with_v3_t1 = wm_t2_with_v3_t2")
summary(BF_v3)

cor(v4[,2:5])
set.seed(123)
cor_v4 <- cor_test(v4[,2:5],iter=50000)
BF_v4 <- BF(cor_v4, hypothesis = "wm_t1_with_v4_t1 > wm_t2_with_v4_t2;wm_t1_with_v4_t1 < wm_t2_with_v4_t2;wm_t1_with_v4_t1 = wm_t2_with_v4_t2")
summary(BF_v4)

cor(v[,2:5])
set.seed(123)
cor_v <- cor_test(v[,2:5],iter=50000)
BF_v <- BF(cor_v, hypothesis = "wm_t1_with_v_t1 > wm_t2_with_v_t2;wm_t1_with_v_t1 < wm_t2_with_v_t2;wm_t1_with_v_t1 = wm_t2_with_v_t2")
summary(BF_v)


# WM transfer tasks
vtrans<-subset(cogito,select=c("obs","wm_trans_t1","wm_trans_t2","v_t1","v_t2"))
v1trans<-subset(cogito,select=c("obs","wm_trans_t1","wm_trans_t2","v1_t1","v1_t2"))
v2trans<-subset(cogito,select=c("obs","wm_trans_t1","wm_trans_t2","v2_t1","v2_t2"))
v3trans<-subset(cogito,select=c("obs","wm_trans_t1","wm_trans_t2","v3_t1","v3_t2"))
v4trans<-subset(cogito,select=c("obs","wm_trans_t1","wm_trans_t2","v4_t1","v4_t2"))

cor(v1trans[,2:5])
set.seed(123)
cor_v1trans <- cor_test(v1trans[,2:5],iter=50000)
BF_v1trans <- BF(cor_v1trans, hypothesis = "wm_trans_t1_with_v1_t1 > wm_trans_t2_with_v1_t2;wm_trans_t1_with_v1_t1 < wm_trans_t2_with_v1_t2;wm_trans_t1_with_v1_t1 = wm_trans_t2_with_v1_t2")
summary(BF_v1trans)

cor(v2trans[,2:5])
set.seed(123)
cor_v2trans <- cor_test(v2trans[,2:5],iter=50000)
BF_v2trans <- BF(cor_v2trans, hypothesis = "wm_trans_t1_with_v2_t1 > wm_trans_t2_with_v2_t2;wm_trans_t1_with_v2_t1 < wm_trans_t2_with_v2_t2;wm_trans_t1_with_v2_t1 = wm_trans_t2_with_v2_t2")
summary(BF_v2trans)

cor(v3trans[,2:5])
set.seed(123)
cor_v3trans <- cor_test(v3trans[,2:5],iter=50000)
BF_v3trans <- BF(cor_v3trans, hypothesis = "wm_trans_t1_with_v3_t1 > wm_trans_t2_with_v3_t2;wm_trans_t1_with_v3_t1 < wm_trans_t2_with_v3_t2;wm_trans_t1_with_v3_t1 = wm_trans_t2_with_v3_t2")
summary(BF_v3trans)

cor(v4trans[,2:5])
set.seed(123)
cor_v4trans <- cor_test(v4trans[,2:5],iter=50000)
BF_v4trans <- BF(cor_v4trans, hypothesis = "wm_trans_t1_with_v4_t1 > wm_trans_t2_with_v4_t2;wm_trans_t1_with_v4_t1 < wm_trans_t2_with_v4_t2;wm_trans_t1_with_v4_t1 = wm_trans_t2_with_v4_t2")
summary(BF_v4trans)

cor(vtrans[,2:5])
set.seed(123)
cor_vtrans <- cor_test(vtrans[,2:5],iter=50000)
BF_vtrans <- BF(cor_vtrans, hypothesis = "wm_trans_t1_with_v_t1 > wm_trans_t2_with_v_t2;wm_trans_t1_with_v_t1 < wm_trans_t2_with_v_t2;wm_trans_t1_with_v_t1 = wm_trans_t2_with_v_t2")
summary(BF_vtrans)
