...
# LATENT CHANGE SCORE MODELS FOR DRIFT RATES (Table 3)
# Masking time=12ms, configural invariance model
v1_t12_conf_lcsm <- '
f_v1_t1 =~ cvt1_v1 + oet1_v1 + syt1_v1 
f_v1_t2 =~ cvt2_v1 + oet2_v1 + syt2_v1
...
fit_v1_t12_conf_lcsm <- sem(v1_t12_conf_lcsm, data=cogito, missing='fiml',estimator='ML')
summary(fit_v1_t12_conf_lcsm,fit.measures=TRUE,standardized=T,modindices=T)

# Masking time=12ms, strong invariance model
v1_t12_strong_lcsm <- '
...
anova(fit_v1_t12_conf_lcsm,fit_v1_t12_strong_lcsm) 

# Masking time=24ms, configural invariance model
v2_t12_conf_lcsm <- '
f_v2_t1 =~ cvt1_v2 + oet1_v2 + syt1_v2 
f_v2_t2 =~ cvt2_v2 + oet2_v2 + syt2_v2
...
fit_v2_t12_conf_lcsm <- sem(v2_t12_conf_lcsm, data=cogito, missing='fiml',estimator='ML')
summary(fit_v2_t12_conf_lcsm,fit.measures=TRUE,standardized=T,modindices=T)

# Masking time=24ms, strong invariance model
v2_t12_strong_lcsm <- '
...
anova(fit_v2_t12_conf_lcsm,fit_v2_t12_strong_lcsm)

# Masking time=47ms, configural invariance model
v3_t12_conf_lcsm <- '
f_v3_t1 =~ cvt1_v3 + oet1_v3 + syt1_v3 
f_v3_t2 =~ cvt2_v3 + oet2_v3 + syt2_v3
...
fit_v3_t12_conf_lcsm <- sem(v3_t12_conf_lcsm, data=cogito, missing='fiml',estimator='ML')
summary(fit_v3_t12_conf_lcsm,fit.measures=TRUE,standardized=T,modindices=T)

# Masking time=47ms, strong invariance model
v3_t12_strong_lcsm <- '
...
anova(fit_v3_t12_conf_lcsm,fit_v3_t12_strong_lcsm)

# Masking time=94ms, configural invariance model
v4_t12_conf_lcsm <- '
f_v4_t1 =~ cvt1_v4 + oet1_v4 + syt1_v4 
f_v4_t2 =~ cvt2_v4 + oet2_v4 + syt2_v4
...
fit_v4_t12_conf_lcsm <- sem(v4_t12_conf_lcsm, data=cogito, missing='fiml',estimator='ML')
summary(fit_v4_t12_conf_lcsm,fit.measures=TRUE,standardized=T,modindices=T)

# Masking time=94ms, strong invariance model
v4_t12_strong_lcsm <- '
...
anova(fit_v4_t12_conf_lcsm,fit_v4_t12_strong_lcsm)

# Aggregated masking time conditions, configural invariance model
v_t12_conf_lcsm <- '
f_v_t1 =~ cvt1_v + oet1_v + syt1_v 
f_v_t2 =~ cvt2_v + oet2_v + syt2_v
...
fit_v_t12_conf_lcsm <- sem(v_t12_conf_lcsm, data=cogito, missing='fiml',estimator='ML')
summary(fit_v_t12_conf_lcsm,fit.measures=TRUE,standardized=T,modindices=T)

# Aggregated masking time conditions, strong invariance model
v_t12_strong_lcsm <- '
...
fit_v_t12_strong_lcsm <- sem(v_t12_strong_lcsm, data=cogito, missing='fiml',estimator='ML')
summary(fit_v_t12_strong_lcsm,fit.measures=TRUE,standardized=T)
anova(fit_v_t12_conf_lcsm,fit_v_t12_strong_lcsm)

# STANDARDIZED FACTOR LOADINGS OF DRIFT RATE LATENT CHANGE MODELS (Table 4)
standardizedsolution(fit_v1_t12_strong_lcsm)
standardizedsolution(fit_v2_t12_strong_lcsm)
standardizedsolution(fit_v3_t12_strong_lcsm)
standardizedsolution(fit_v4_t12_strong_lcsm)
standardizedsolution(fit_v_t12_strong_lcsm)